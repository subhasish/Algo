...
// Custom hash function to use STL. If we do it this way then we will have to pass this class as template parameter
// If we just declare the specialization of hash<ConctactList> then we do not need to pass the third parameter
...
int main()
{
	...
	unordered_map<ContactList, int, HashContactList> custom_map;
	custom_map[c1] = 2;
