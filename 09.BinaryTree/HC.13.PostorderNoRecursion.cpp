...
//			and right subtree of the node is explored or not. We call it visited flag.
//
//			If visited flag is not set we try to explore the left and right subtrees and set the flag.
//			We don't pop the node from the stack so that it gets processed after its
//			children are processed.
//
//			If the visited flag is set then we pop that element from the stack and process/print it.
//
